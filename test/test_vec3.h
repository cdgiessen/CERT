...
{
	constexpr auto zero = VEC3_ZERO;
	constexpr auto v_one = VEC3_ONE;
	...
	constexpr auto len_pre_v1 = Vec3 (0, 3, 4);
	constexpr auto len_pre_v2 = Vec3 (3, 0, 4);
	constexpr auto len_pre_v3 = Vec3 (3, 4, 0);
